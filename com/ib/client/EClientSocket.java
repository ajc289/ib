...
public class EClientSocket {
    ...
    public synchronized void reqHistoricalData( int tickerId, Contract contract,
        ...
        try {
          ...
          System.out.println("my_symbol " + contract.m_symbol);
          System.out.println("m_sectype " + contract.m_secType);
          System.out.println("m_expiry " + contract.m_expiry);
          System.out.println("m_strike " + contract.m_strike);
          System.out.println("m_right " + contract.m_right);
          System.out.println("m_mult " + contract.m_multiplier);
          System.out.println("m_exchange " + contract.m_exchange);
          System.out.println("m_prim " + contract.m_primaryExch);
          System.out.println("m_curr " + contract.m_currency);
          System.out.println("m_local " + contract.m_localSymbol);
          System.out.println ("enddatetime " + endDateTime);
          System.out.println ("durationstr " + durationStr);
          System.out.println ("barsizesetting " + barSizeSetting);
          System.out.println ("whattoshow " + whatToShow);
          System.out.println ("userth " + useRTH);
